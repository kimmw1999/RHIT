...
def run_test_draw_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    # Test 1:
    title = "Test 4: 5 red on unfilled"
...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    # Test 1:
    title = "PIZZA test 4:  10 slices, thin (thickness=3) black lines."
    window = rg.RoseWindow(700, 600, title)
    circle = rg.Circle(rg.Point(350, 300), 250)
    circle.outline_thickness = 3
    pizza(window, circle, 10, "black", 3)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # -------------------------------------------------------------------------
    title = ("POLYGON tests 3:  4 segments with thick red lines;"
             )
...
def run_test_fancy_polygon():
    ...
    title = ("FANCY POLYGON test 4:  51 lime green lines on blue circle,"
             + " hops = 25.")
