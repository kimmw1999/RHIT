...
def try_methods():
    ...
    turtle_try.pen=rg.Pen("brown",5)
    turtle_try.forward(150)
    turtle_try.left(90)
    turtle_try.forward(50)
    turtle_try.backward(100)
...
def try_methods_and_functions():
    ...
    draw_many_squares(last_turtle, 8, 300, 60)

    second_last=rg.SimpleTurtle()
    second_last.pen=rg.Pen("black",3)
    second_last.forward(200)
    second_last.draw_circle(30)
    second_last.draw_square(50)
