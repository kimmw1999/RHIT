...
def main():
    ...
    even_better_draw_circles(rg.Point(100,50),30,10,"red",10)
    window.update()
...
###############################################################################
def better_draw_circles(point, diffrad):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(diffrad * k)  # Radius 15, 30, 45, 60, ...
...
###############################################################################
def even_better_draw_circles(point, diffrad, numcir, color, thick):
    ...
    for k in range(numcir):  # k becomes 1, 2, 3, ... 10
