...
def run_test_next_prime():
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 17
    print_expected_result_of_test([16], expected, test_results, format_string)
...
def run_test_wait_for_sum_of_cubes():
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 3
    print_expected_result_of_test([33], expected, test_results,
                                  format_string)
