...
def input_it_all():
    ...
    new_string=""
    new_string=new_string + str(integer) + " "
    new_string=new_string + str(number)+ " "
    new_string=new_string + str(round(integer+number, 3)) + " "
    new_string=new_string + str(round(math.sin(integer+number), 2))+ " "
    new_string=new_string + string*integer
    return new_string
