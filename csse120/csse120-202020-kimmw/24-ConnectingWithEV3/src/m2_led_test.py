...
# -----------------------------------------------------------------------------
# DONE: 2. As usual when there is a file of "library" code (here, the
#   rosebot_ev3dev_api.py file), Right-Click on the  src  folder
#   and select   Mark Directory As -> Sources Root.
# -----------------------------------------------------------------------------

# -----------------------------------------------------------------------------
# DONE: 3.  Uncomment the IMPORT line below (the one that is commented-out).
...
def main():
    # -------------------------------------------------------------------------
    # DONE: 4. Create a Led object for the RIGHT LED by examining the code
    #          below for the LEFT LED and doing similarly for the RIGHT LED.
    # -------------------------------------------------------------------------
    left_led = rose_ev3.Led("left")
    right_led=rose_ev3.Led("right")

    # -------------------------------------------------------------------------
    # DONE: 5. Modify the example code below to make something interesting
    ...
    for k in range(10):
        ...
        time.sleep(0.25)
    for k in range(10):
        right_led.set_color("red")
        time.sleep(0.25)
        right_led.turn_off()
        time.sleep(0.25)
    left_led.set_color("green")
    right_led.set_color("green")
    print("Goodbye")
