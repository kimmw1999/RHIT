...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         many others before them, and now Martino Kim.
...
#      differs from the output from  example_2. j and k in example_1 are independent, but j and k in example_2 are dependent.
#  __
