...
def run_test_problem3a():
    ...
    # -------------------------------------------------------------------------
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (60, 80), 5 lines'
    window4 = rg.RoseWindow(650, 200, title)

    # Test 5 (it is on window 4):
    point = rg.Point(60, 80)
    expected = 25
...
def problem3a(window, point, n):
    ...
    for k in range(n):
        a = point.x
        b = point.y + 50
        line=rg.Line(point,rg.Point(a,b))
        if(k<=6):
...
def problem3b(m, point1):
    ...
    for k in range(m):
        a=point1.x
        b=point1.y+60*k
        total=total+problem3a(window,rg.Point(a,b),3+2*k)
