...
def run_test_display_color_names(robot):
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        print("Color name = ", robot.color_sensor.get_color_as_name())
        print("Color number = ", str(robot.color_sensor.get_color_as_number()))
...
def run_test_drive_until_color(robot):
    ...
    robot.color_sensor.wait_for_color("white")
    print("white is here")
    ...
    print("black is here")
    robot.drive_system.stop()
    input("Press the Enter key when ready to wait until red is sensed.")
...
def run_test_display_reflected_light_readings(robot):
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        print("Reflected light percentage = ", end="")
        print(str(robot.color_sensor.get_reflected_light_intensity()), end="  ")
        if robot.color_sensor.get_reflected_light_intensity()>90:
            print("White")
        else:
            print("Black")
        # -------------------------------------------------------------------------
...
def run_test_calibrate_line_follower(robot):
    ...
    while True:
        ...
        print("threshold = ", end="")
        print((robot.line_follower.white_reading + robot.line_follower.black_reading)/2)
...
def run_test_line_follower(robot):
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        robot.line_follower.calibrate()
        robot.line_follower.follow_line_inside_ccw(50, 5)
        robot.drive_system.stop()
        # -------------------------------------------------------------------------
        # TODO: 11. Optional
