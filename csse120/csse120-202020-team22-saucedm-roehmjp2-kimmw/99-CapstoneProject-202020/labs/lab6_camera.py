...
def run_test_blob_readings(robot):
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        print(robot.camera_sensor.get_biggest_blob().__repr__())
...
def run_test_fetch(robot):
    robot.camera_tracker.fetch(50)
