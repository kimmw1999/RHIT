...
Authors: David Fisher and Martino Kim.
...
def main():
    ...
    # -------------------------------------------------------------------------
    # DONE: 4. Look at the names of the functions called for each button.
...
# -------------------------------------------------------------------------
# DONE: 5. Implement the functions for the drive button callbacks.
# -------------------------------------------------------------------------
...
def send_up(mqtt_client):
    print("drive_system", "up")
    mqtt_client.send_message("drive_system", "up")
def send_down(mqtt_client):
    print("drive_system", "down")
    mqtt_client.send_message("drive_system", "down")


# -------------------------------------------------------------------------
# DONE: 6. Implement the functions for the arm callbacks.
# -------------------------------------------------------------------------
def send_up(mqtt_client):
    print("arm_and_claw", "up")
    mqtt_client.send_message("arm_and_claw", "raise_arm")


# -------------------------------------------------------------------------
# DONE: 7. Implement the functions for the arm callbacks.
# -------------------------------------------------------------------------
def send_down(mqtt_client):
    print("arm_and_claw", "down")
