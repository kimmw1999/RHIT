...
class RemoteControl(object):
    ...
    def __init__(self):
        ...
        self.remote_controls = [remote_control_1,
                                remote_control_2,
                                remote_control_3,
                                remote_control_4]
    ...
    def is_pressed(self, channel, button_name):
        ...
        if button_name == "red_up":
            if self.remote_controls[channel-1].red_up() == True:
                return True
            return False
        if button_name == "red_down":
            if self.remote_controls[channel - 1].red_down() == True:
                return True
            return False
        if button_name == "blue_up":
            if self.remote_controls[channel-1].blue_up() == True:
                return True
            return False
        if button_name == "blue_down":
            if self.remote_controls[channel-1].blue_down() == True:
                return True
            return False
    ...
    def wait_until_pressed(self, channel, button):
        ...
        while True:
            time.sleep(0.05)
            if self.is_pressed(channel, button) is True:
                break
