...
class ColorSensor(object):
    ...
    def get_color_as_name(self):
        ...
        # ---------------------------------------------------------------------
        return self.sensor.get_color_as_name()
    ...
    def get_color_as_number(self):
        ...
        # TODO: Implement this method.
        # ---------------------------------------------------------------------
        return self.sensor.get_color_as_number()
    ...
    def wait_for_color(self, color):
        ...
        # TODO: Implement this method.
        # ---------------------------------------------------------------------
        default=color[0].upper()
        for k in range(1, len(color)):
            default=default+color[k].lower()
        while True:
            time.sleep(0.05)
            if self.get_color_as_name() == default:
                break
